...
const menu: MenuCategory[] = [
    ...
    },
    {
        ...
        elementos: [
            { label: 'CARTA LEY 1429 de 2010', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/CARTA_LEY_1429_2010.docx', description: '...' },
            { label: 'FORMATO DE EVIDENCIA DE IDENTIFICACION DE LA PERSONA QUE REALIZA TRAMITE PRESENCIAL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_EVIDENCIA_IDENTIFICACIÓN_LA_PERSONA_QUE_REALIZA_TRÁMITE_PRESENCIAL.docx', description: '...' },
            { label: 'FORMATO DE AUTORIZACION DE MATRICULAS E INSCRIPCIONES', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/Formato de Autorización de Matrículas e Inscripciones Inactivas.docx', description: '...' },
            { label: 'FORMATO PARA CAMBIO DE ACTIVIDAD COMERCIAL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_PARA_CAMBIO_ACTIVIDAD_COMERCIAL.docx', description: '...' },
            { label: 'FORMATO DE REGISTRO DE LIBROS', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_REGISTRO_LIBROS.docx', description: '...' },
            { label: 'FORMATO PARA CAMBIO DE NOMBRE DE AGENCIA', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_PARA_CAMBIO_NOMBRE_AGENCIA.docx', description: '...' },
            { label: 'FORMATO PARA CAMBIO DE DIRECCIÓN Y ACTIVIDAD ECONÓMICA', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_PARA_CAMBIO_DIRECCIÓN_ACTIVIDAD_ECONÓMICA.docx', description: '...' },
            { label: 'FORMATO PARA PETICIONES Y CONSULTAS', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/Formato para peticiones y consultas.docx', description: '...' },
            { label: 'FORMATO PARA CAMBIO DE NOMBRE DE ESTABLECIMIENTO DE COMERCIO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/Formato para Cambio de Nombre de Establecimiento de Comercio.docx', description: '...' },
            { label: 'REQUISITOS APERTURA DE SUCURSAL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS APERTURA DE SUCURSAL.docx', description: '...' },
            { label: 'FORMATO PARA TRASLADO DE DOMICILIO PERSONA NATURAL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_PARA_TRASLADO_DOMICILIO_PERSONA_NATURAL.docx', description: '...' },
            { label: 'REQUISITOS COMPRAVENTA A TITULO GRATUITO DE ESTABLECIMIENTO DE COMERCIO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITO_COMPRAVENTA_CESIÓN_TITULO_GRATUITO_ESTABLECIMIENTO_COMERCIO.docx', description: '...' },
            { label: 'REQUISITO MATRICULA DE PERSONAL NATURAL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_MATRICULA_PERSONA_NATURAL.docx', description: '...' },
            { label: 'REQUISITOS CONSTITUCION EAT', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITO_CONSTITUCIÓN_EAT.docx', description: '...' },
            { label: 'REQUISITOS CANCELACION DE PERSONA NATURAL - ESTABLECIMIENTO DE COMERCIO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_CANCELACIÓN_PERSONA_NATURAL_ESTABLECIMIENTO_COMERCIO.docx', description: '...' },
            { label: 'REQUISITOS CONSTITUCION ENTIDADES DEL SECTOR SOLIDARIO', link: '', description: '...' },
            { label: 'REQUISITOS CONSTITUCION DE ENTIDADES SIN ANIMO DE LUCRO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITO_CONSTITUCIÓN_SIN_ANIMO_LUCRO.docx', description: '...' },
            { label: 'REQUISITOS DE APERTURA DE AGENCIA', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_PARA_APERTURA_AGENCIA.docx', description: '...' },
            { label: 'REQUISITOS CONSTITUCION EMPRESA UNIPERSONAL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_CONSTITUCIÓN_EMPRESA_UNIPERSONAL.docx', description: '...' },
            { label: 'REQUISITOS MATRICULA SOCIEDAD DE HECHO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITO_MATRICULA_SOCIEDAD_HECHO.docx', description: '...' },
            { label: 'REQUISITOS CONSTITUCION SOCIEDADES COMERCIALES', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_CONSTITUCIÓN_SOCIEDADES_COMERCIALES.docx', description: '...' },
            { label: 'SOLICITUD DE CANCELACION MATRICULA MERCANTIL', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/SOLICITUD_CANCELACIÓN_MATRÍCULA_MERCANTIL.docx', description: '...' },
            { label: 'REQUISITOS DISOLUCION Y LIQUIDACION ENTIDAD SIN ANIMO DE LUCRO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_PARA_DISOLUCION_ESADL.docx', description: '...' },
            { label: 'SOLICITUD DE REVOCACION DATOS PERSONALES', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/SOLICITUD_REVOCACIÓN_AUTORIZACIÓN_DATOS_PERSONALES .docx', description: '...' },
            { label: 'SOLICITUD ACCESO A DATOS PERSONALES', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/Solicitud de Acceso a Datos Personales.docx', description: '...' },
            { label: 'Modelo Capacidad Operativa Persona Natural', link: '', description: '...' },
            { label: 'SOLICITUD DE RECTIFICACION O ACTUALIZACION DE DATOS PERSONALES', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/SOLICITUD_RECTIFICACIÓN_ACTUALIZACIÓN_DATOS_PERSONALES.docx', description: '...' },
            { label: 'SOLICITUD DE SUPRESION DE DATOS PERSONALES', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/SOLICITUD_SUPRESIÓN_DATOS_PERSONALES.docx', description: '...' },
            ...
            { label: 'Modelo Cumplimiento Ley 1336 de 2009 Persona Jurídica', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/CUMPLIMIENTO_LEY_1336_2009_PJ.docx', description: '...' },
            ...
            { label: 'Modelo Cumplimiento Ley 1336 de 2009 Persona Natural', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/CUMPLIMIENTO_LEY_1336_2009_PERSONA_NATURAL.docx', description: '...' },
            { label: 'Modelo Capacidad Operativa Persona Jurídica', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/MODELO_CAPACIDAD_OPERATIVA_PJ_v2.docx', description: '...' },
            { label: 'Formato 1 Socio Unico Controlante - Decreto 667 de 2018', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/FORMATO_1_DECRETO_667_2018.pdf', description: '...' }
        ]
    }
];
