...
const menu: MenuCategory[] = [
    ...
    },
    {
        ...
        elementos: [
            ...
            { label: 'REQUISITOS CONSTITUCION EAT', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITO CONSTITUCIÓN EAT.docx', description: '...' },
            ...
            { label: 'REQUISITOS DISOLUCION Y LIQUIDACION ENTIDAD SIN ANIMO DE LUCRO', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/REQUISITOS_DISOLUCIÓN_LIQUIDACIÓN_ENTIDAD_SIN_ÁNIMO_LUCRO.docx', description: '...' },
            ...
            { label: 'Modelo Capacidad Operativa Persona Jurídica', link: 'docs/MODELOS_ACTOS_DOCUMENTOS/DOCUMENTOS_APOYO/MODELO_CAPACIDAD_OPERATIVA_PJ.docx', description: '...' },
